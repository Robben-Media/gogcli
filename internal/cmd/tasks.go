...
type TasksCmd struct {
	...
	Update  TasksUpdateCmd  `cmd:"" name:"update" help:"Update a task (partial)" aliases:"patch"`
	Replace TasksReplaceCmd `cmd:"" name:"replace" help:"Replace a task entirely (full replace)"`
	Move    TasksMoveCmd    `cmd:"" name:"move" help:"Move a task within a list"`
